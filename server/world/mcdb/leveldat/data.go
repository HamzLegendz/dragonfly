...
func (d *Data) FillDefault() {
	...
	d.CommandsEnabled = false // Patch: false agar achievements dapat diaktifkan
	d.Difficulty = 3 // Patch: Hard difficulty
	...
	d.GameType = 1
	d.Generator = 2
	d.HasBeenLoadedInCreative = false // Patch: false agar achievements tidak terkunci
